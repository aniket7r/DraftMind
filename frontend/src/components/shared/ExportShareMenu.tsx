import { Share2, FileDown, Image, Copy, Loader2 } from 'lucide-react';
...
export function ExportShareMenu({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-52 bg-popover border-card-border">
        ...
        <DropdownMenuItem onClick={onShareTwitter} className="cursor-pointer">
          <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
          </svg>
          Share on X
        </DropdownMenuItem>
        <DropdownMenuItem onClick={onShareReddit} className="cursor-pointer">
          <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
        ...
        <DropdownMenuItem onClick={onCopyShareText} className="cursor-pointer">
